...
- During `prepare-pr`, use this commit subject format: `fix: <summary> (minion#<PR>) thanks @<pr-author>`.
...
- Read `docs/help/submitting-a-pr.md` ([Submitting a PR](https://docs.minion.ai/help/submitting-a-pr)) for what we expect from contributors.
