...
- `fix: <summary> (minion#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (minion#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "minion#$pr_number" || { echo "ERROR: commit subject missing minion#$pr_number"; exit 1; }
