...
- **Use Case**: If Minion integrates with Azure/.NET
...
```json
{
  "mcpServers": {
    "git": {
      ...
      "cwd": "/home/nikolas/Documents/CODE/AI/minion"
    }
  }
}
```
...
## Recommended Setup for Minion Docs Skill
...
- Minion: https://github.com/minion/minion/discussions
