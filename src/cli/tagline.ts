const DEFAULT_TAGLINE = "All your chats, one Minion.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little mini-stant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just got a minion—type something and let the bot handle the busywork.",
  ...
  "Automation with tentacles: minimal fuss, maximal grip.",
  ...
  "I'll ink your workflow like a fresh catch: messy, delicious, effective.",
  "Shell yeah—I'm here to grab the toil and leave you the glory.",
  ...
  "The only squid in your contacts you actually want to hear from. 🦑",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.MINION_TAGLINE_INDEX;
