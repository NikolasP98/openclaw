...
const CORE_PACKAGE_NAMES = new Set(["@nikolasp98/minion", "minion", "openclaw"]);
...
export async function resolveMinionPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveMinionPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
