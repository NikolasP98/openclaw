...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@minion", { botUsername: "minion" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@minion args", {
        botUsername: "minion",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "minion" })).toBe(
      "/help@otherbot",
    );
  });
