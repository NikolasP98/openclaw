import type { StickerMetadata } from "../channels/impl/telegram/bot/types.js";
import type { ChannelId } from "../channels/plugins/types.js";
import type {
  MediaUnderstandingDecision,
  MediaUnderstandingOutput,
} from "../media-understanding/types.js";
import type { InternalMessageChannel } from "../shared/message-channel.js";
...
export type MsgContext = {
  ...
  OutputDir?: string;
  OutputBase?: string;
  /** Remote host for SCP when media lives on a different machine (e.g., minion@192.168.64.3). */
