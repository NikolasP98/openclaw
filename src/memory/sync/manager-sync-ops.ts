...
import { DEFAULT_GEMINI_EMBEDDING_MODEL } from "../embedding/embeddings-gemini.js";
import { DEFAULT_OPENAI_EMBEDDING_MODEL } from "../embedding/embeddings-openai.js";
import { DEFAULT_VOYAGE_EMBEDDING_MODEL } from "../embedding/embeddings-voyage.js";
import {
    ...
    try {
      if (needsFullReindex) {
        if (
          ...
          process.env.MINION_TEST_MEMORY_UNSAFE_REINDEX === "1"
        ) {
