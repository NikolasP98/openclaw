...
export type MinionPluginConfigSchema = {
...
export type MinionPluginToolContext = {
  config?: MinionConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type MinionPluginToolFactory = (
  ctx: MinionPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type MinionPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type MinionPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<MinionConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type MinionPluginGatewayMethod = {
  method: string;
 ...
 */
export type MinionPluginCommandDefinition = {
...
export type MinionPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type MinionPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type MinionPluginCliContext = {
  program: Command;
  config: MinionConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type MinionPluginCliRegistrar = (ctx: MinionPluginCliContext) => void | Promise<void>;

export type MinionPluginServiceContext = {
  config: MinionConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type MinionPluginService = {
  id: string;
  start: (ctx: MinionPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: MinionPluginServiceContext) => void | Promise<void>;
};

export type MinionPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type MinionPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: MinionPluginConfigSchema;
  register?: (api: MinionPluginApi) => void | Promise<void>;
  activate?: (api: MinionPluginApi) => void | Promise<void>;
};

export type MinionPluginModule =
  | MinionPluginDefinition
  | ((api: MinionPluginApi) => void | Promise<void>);

export type MinionPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | MinionPluginToolFactory,
    opts?: MinionPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: MinionPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: MinionPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: MinionPluginHttpRouteHandler }) => void;
  registerChannel: (registration: MinionPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: MinionPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: MinionPluginService) => void;
   ...
   */
  registerCommand: (command: MinionPluginCommandDefinition) => void;
...
// Backward-compat aliases — upstream uses OpenClaw* naming
/** @deprecated Use MinionPluginCommandDefinition */
export type OpenClawPluginCommandDefinition = MinionPluginCommandDefinition;
/** @deprecated Use MinionPluginModule */
export type OpenClawPluginModule = MinionPluginModule;
/** @deprecated Use MinionPluginDefinition */
export type OpenClawPluginDefinition = MinionPluginDefinition;
/** @deprecated Use MinionPluginApi */
export type OpenClawPluginApi = MinionPluginApi;
/** @deprecated Use MinionPluginService */
export type OpenClawPluginService = MinionPluginService;
/** @deprecated Use MinionPluginServiceContext */
export type OpenClawPluginServiceContext = MinionPluginServiceContext;
/** @deprecated Use MinionPluginToolContext */
export type OpenClawPluginToolContext = MinionPluginToolContext;
