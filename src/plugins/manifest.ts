...
// package.json "minion" metadata (used for onboarding/catalog)
...
export type MinionPackageManifest = {
  extensions?: string[];
...
): MinionPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
...
export type OpenClawPackageManifest = MinionPackageManifest;
