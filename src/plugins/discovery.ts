...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @minion/voice-call -> voice-call).
...
export function discoverMinionPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".minion", "extensions")];
...
/** @deprecated Use discoverMinionPlugins */
export const discoverOpenClawPlugins = discoverMinionPlugins;
