...
import type { MinionConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: MinionConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  ...
  onHotReload: (plan: GatewayReloadPlan, nextConfig: MinionConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: MinionConfig) => void;
  log: {
