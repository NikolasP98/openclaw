...
function resolveAvatarSource(cfg: MinionConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: MinionConfig, agentId: string): AgentAvatarResolution {
