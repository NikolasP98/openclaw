...
function resolveWatchPaths(workspaceDir: string, config?: MinionConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: MinionConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: MinionConfig }) {
