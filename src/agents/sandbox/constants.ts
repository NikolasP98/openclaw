...
export const DEFAULT_SANDBOX_IMAGE = "minion-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "minion-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "minion-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "minion-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "minion-sbx-browser-";
