...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/minion/minion/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.MINION_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.minion/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: MinionConfig = {
    ...params.cfg,
