...
const execHostEnforced = process.env.MINION_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.MINION_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
