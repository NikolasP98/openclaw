...
export const A2UI_PATH = "/__minion__/a2ui";

export const CANVAS_HOST_PATH = "/__minion__/canvas";

export const CANVAS_WS_PATH = "/__minion__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.minionCanvasA2UIAction.postMessage(...)
  // - Android: window.minionCanvasA2UIAction.postMessage(...)
  const handlerNames = ["minionCanvasA2UIAction"];
  ...
  globalThis.Minion = globalThis.Minion ?? {};
  globalThis.Minion.postMessage = postToNode;
  globalThis.Minion.sendUserAction = sendUserAction;
  globalThis.minionPostMessage = postToNode;
  globalThis.minionSendUserAction = sendUserAction;
