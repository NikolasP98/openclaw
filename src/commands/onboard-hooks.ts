...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.minion.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("minion hooks list")}`,
      `  ${formatCliCommand("minion hooks enable <name>")}`,
      `  ${formatCliCommand("minion hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
