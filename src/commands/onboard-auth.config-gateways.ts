...
export function applyVercelAiGatewayProviderConfig(cfg: MinionConfig): MinionConfig {
...
export function applyVercelAiGatewayConfig(cfg: MinionConfig): MinionConfig {
