...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "minion-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<MinionConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<MinionConfig["telegram"]>>,
