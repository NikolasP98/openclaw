...
export function listBindings(cfg: MinionConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: MinionConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: MinionConfig) {
