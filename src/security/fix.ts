...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof MinionConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: MinionConfig; env: NodeJS.ProcessEnv }): {
  cfg: MinionConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
