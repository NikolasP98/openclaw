...
export type ChannelAgentToolFactory = (params: { cfg?: MinionConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: MinionConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: MinionConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: MinionConfig }) => boolean;
  supportsCards?: (params: { cfg: MinionConfig }) => boolean;
