...
import type { MinionPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverMinionPlugins } from "../../plugins/discovery.js";
...
const ENV_CATALOG_PATHS = ["MINION_PLUGIN_CATALOG_PATHS", "MINION_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<MinionPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: MinionPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: MinionPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverMinionPlugins({ workspaceDir: options.workspaceDir });
