...
export function listZalouserAccountIds(cfg: MinionConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: MinionConfig): string {
...
function mergeZalouserAccountConfig(cfg: MinionConfig, accountId: string): ZalouserAccountConfig {
