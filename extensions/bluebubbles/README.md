...
This directory contains the **BlueBubbles external channel plugin** for Minion.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `minion/plugin-sdk` helpers.
