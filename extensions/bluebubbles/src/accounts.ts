...
export function listBlueBubblesAccountIds(cfg: MinionConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: MinionConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: MinionConfig): ResolvedBlueBubblesAccount[] {
