import { resolveChannelMediaMaxBytes, type MinionConfig } from "minion/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: MinionConfig; accountId?: string }): string[] {
