...
export function listGoogleChatAccountIds(cfg: MinionConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: MinionConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: MinionConfig): ResolvedGoogleChatAccount[] {
