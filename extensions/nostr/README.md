...
Nostr DM channel plugin for Minion using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Minion. It enables your bot to:
...
# Configure minion to use local relay
