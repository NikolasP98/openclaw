import type { ChannelOnboardingAdapter, MinionConfig, WizardPrompter } from "minion/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.minion.ai/channels/mattermost",
    ].join("\n"),
