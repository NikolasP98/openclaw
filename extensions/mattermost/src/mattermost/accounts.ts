...
export function listMattermostAccountIds(cfg: MinionConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: MinionConfig): string {
...
export function listEnabledMattermostAccounts(cfg: MinionConfig): ResolvedMattermostAccount[] {
