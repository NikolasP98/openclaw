---
summary: "Use NVIDIA's OpenAI-compatible API in Minion"
read_when:
  - You want to use NVIDIA models in Minion
...
minion onboard --auth-choice skip
minion models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
