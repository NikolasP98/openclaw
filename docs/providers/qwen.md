---
summary: "Use Qwen OAuth (free tier) in Minion"
read_when:
  - You want to use Qwen with Minion
...
If you already logged in with the Qwen Code CLI, Minion will sync credentials
