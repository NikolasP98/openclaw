---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Minion"
read_when:
  - You want Xiaomi MiMo models in Minion
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Minion uses
