---
summary: "Use Qianfan's unified API to access many models in Minion"
read_when:
...
3. Minion installed on your system
...
4. Copy the API key for use with Minion

## CLI setup

```bash
minion onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Minion Configuration](/gateway/configuration)
