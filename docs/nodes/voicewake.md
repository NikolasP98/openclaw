...
Minion treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.minion/settings/voicewake.json`

Shape:

```json
{ "triggers": ["minion", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
