...
- Install via CLI: `minion plugins install @minion/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `minion plugins install ./extensions/zalo`
   - From npm (if published): `minion plugins install @minion/zalo`
...
- Approve via:
  - `minion pairing list zalo`
  - `minion pairing approve zalo <CODE>`
...
- Example: `minion message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `minion channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `minion logs --follow`
