---
summary: "Overview of Minion onboarding options and flows"
read_when:
...
Minion supports multiple onboarding paths depending on where the Gateway runs
...
- [`minion onboard` command](/cli/onboard)

## macOS app onboarding

Use the Minion app when you want a fully guided setup on macOS. Docs:
