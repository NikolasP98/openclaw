---
summary: "First-run onboarding flow for Minion (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Minion">
...
<Step title="CLI">
  ...
  The app can install the global `minion` CLI via npm/pnpm so terminal
