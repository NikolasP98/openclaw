...
read_when:
  - You are building a Minion plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (minion.plugin.json)

Every plugin **must** ship a `minion.plugin.json` file in the **plugin root**.
Minion uses this manifest to validate configuration **without executing plugin
