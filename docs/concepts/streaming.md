...
Minion has two separate “streaming” layers:
...
When block streaming is enabled, Minion can **merge consecutive block chunks**
...
When draft streaming is active, Minion disables block streaming for that reply to avoid double-streaming.
