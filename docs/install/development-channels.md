...
Minion ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Minion also aligns
the install method:
...
When you switch channels with `minion update`, Minion also syncs plugin sources:
