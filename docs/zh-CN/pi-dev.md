...
本指南总结了在 Minion 中开发 Pi 集成的合理工作流程。
...
状态存储在 Minion 状态目录下。默认为 `~/.minion`。如果设置了 `MINION_STATE_DIR`，则使用该目录。
...
- https://docs.minion.ai/testing
- https://docs.minion.ai/start/getting-started
