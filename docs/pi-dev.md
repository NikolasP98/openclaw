...
This guide summarizes a sane workflow for working on the pi integration in Minion.
...
- Trigger the agent directly:
  - `pnpm minion agent --message "Hello" --thinking low`
...
State lives under the Minion state directory. Default is `~/.minion`. If `MINION_STATE_DIR` is set, use that directory instead.

To reset everything:

- `minion.json` for config
...
- [https://docs.minion.ai/testing](https://docs.minion.ai/testing)
- [https://docs.minion.ai/start/getting-started](https://docs.minion.ai/start/getting-started)
