...
- Keep product names in English: Minion, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Minion Gateway, use “Gateway 网关”.
