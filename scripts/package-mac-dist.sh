...
# Output:
# - dist/Minion.app
# - dist/Minion-<version>.zip
# - dist/Minion-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Minion-$VERSION.zip"
DMG="$ROOT_DIR/dist/Minion-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Minion-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Minion-$VERSION.dSYM.zip"
