...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "minion", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Minion. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Minion Issue Label Audit");
