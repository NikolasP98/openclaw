...
show_usage() {
    cat << EOF
clawlog - Minion Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Minion logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Minion logs flow through the macOS unified log (subsystem: ai.minion).
